...
function innerResultToClient(data) {
    ...
    Object.entries(data).forEach(item => {
        ...
        for (let i = 0; i < item[1].length; i++) {
            ...
            span.innerHTML = `
                   <span>${item[0]} - тип Сортировки: ${(_a = item[1][i]) === null || _a === void 0 ? void 0 : _a.sortType} - размер Массива: ${(_b = item[1][i]) === null || _b === void 0 ? void 0 : _b.arraySize} -count: ${(_c = item[1][i]) === null || _c === void 0 ? void 0 : _c.count}</span> 
                `;
