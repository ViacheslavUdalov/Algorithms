...
export var ALGO_STATUSES;
(function (ALGO_STATUSES) {
    ALGO_STATUSES["VALID"] = "VALID";
    ALGO_STATUSES["MISSING"] = "MISSING";
    ALGO_STATUSES["CALCULATING"] = "CALCULATING";
    ALGO_STATUSES["INVALID"] = "INVALID";
})(ALGO_STATUSES || (ALGO_STATUSES = {}));
export var ALGO_MESSAGES;
(function (ALGO_MESSAGES) {
    ALGO_MESSAGES["oneUpdated"] = "oneUpdated";
    ALGO_MESSAGES["allUpdated"] = "allUpdated";
    ALGO_MESSAGES["extra"] = "extra";
})(ALGO_MESSAGES || (ALGO_MESSAGES = {}));
class AlgoResults {
    constructor() {
        this.times = {
            random: undefined,
